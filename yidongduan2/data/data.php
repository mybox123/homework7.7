<?php 
	...
	if ($type == 'list') {
		if ($page == 1) {
			$str = '{ "records":[ 
						{"Name":"刘备","City":"德州","Country":"中国","age":20}, 
						{"Name":"关羽","City":"济南","Country":"中国","age":25}, 
						{"Name":"杨万卉","City":"休斯顿","Country":"美国","age":40}, 
						{"Name":"德川家康—周跃强","City":"日本","Country":"中国","age":23}, 
						{"Name":"马超","City":"华盛顿","Country":"美国","age":42}, 
						{"Name":"刘德华","City":"香港","Country":"中国","age":36}, 
						{"Name":"查理","City":"越南","Country":"越南","age":18}, 
						{"Name":"张飞","City":"禹城","Country":"中国","age":2}, 
						{"Name":"普京","City":"莫斯科","Country":"俄罗斯","age":57}, 
						{"Name":"许褚","City":"平壤","Country":"朝鲜","age":28}
						] 
					}';
		}else if ($page == 2) {
			$str = '{ "records":[ 
